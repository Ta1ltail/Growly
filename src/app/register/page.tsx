...
function evaluateStrength(pw: string): {
  ...
  if (score === 2) return { score, label: "Fair", color: "#f97316", bars: 2 };
  if (score === 3) return { score, label: "Good", color: "#eab308", bars: 3 };
        ...
        <div className="flex w-full max-w-md flex-col lg:flex-row lg:gap-12 lg:max-w-4xl lg:items-center">
          ...
          <div className="hidden lg:block lg:w-1/2 lg:pr-8">
            ...
            <p className="mt-3 max-w-sm text-sm leading-relaxed text-muted">
              Create your free account and start building streaks that matter.
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="group relative">
                  <User className="pointer-events-none absolute left-3.5 top-1/2 z-10 size-[18px] -translate-y-1/2 text-muted transition-colors duration-200 group-focus-within:text-accent" />
                  <input
                    id="username"
                    type="text"
                    value={username}
