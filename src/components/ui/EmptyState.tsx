  ...
  return (
    <svg viewBox="0 0 120 90" className="size-28" fill="none">
      <rect
        ...
        height="70"
        rx="8"
        className="fill-surface2 stroke-accent/30"
        strokeWidth="1.5"
      />
      <line
        x1="22"
...
function AchievementsIllo() {
  return (
    <svg viewBox="0 0 120 90" className="size-28" fill="none">
      <path
        d="M60 5l8 25h26l-20 15 8 25-22-16-22 16 8-25L26 30h26L60 5z"
        className="fill-accent/10 stroke-amber-400"
        strokeWidth="1.5"
        strokeLinejoin="round"
      />
      <circle
      ...
      <rect
        ...
        height="16"
        rx="4"
        className="stroke-accent/30 fill-surface2"
        strokeWidth="1"
      />
      <rect
        x="46"
  ...
  return (
    <svg viewBox="0 0 120 90" className="size-28" fill="none">
      ...
      <text
        ...
        y="62"
        textAnchor="middle"
        className="fill-accent text-[11px] font-bold"
        fontSize="11"
      >
        ✦
      </text>
      ...
      />
      <path
        d="M35 30V22a5 5 0 015-5h40a5 5 0 015 5v8"
        className="stroke-line"
        strokeWidth="1.5"
      />
  ...
  return (
    <svg viewBox="0 0 120 90" className="size-28" fill="none">
      <rect
        ...
        height="20"
        rx="4"
        className="fill-surface2 stroke-line"
        strokeWidth="1"
      />
      <rect
        x="25"
...
function TodayIllo() {
  return (
    <svg viewBox="0 0 120 90" className="size-28" fill="none">
      ...
      />
      <path
        d="M60 10l8 16 18-4-12 14 5 18-19-8-19 8 5-18L34 22l18 4L60 10z"
        className="fill-accent/10 stroke-amber-400"
        strokeWidth="1.5"
        strokeLinejoin="round"
      />
      ...
      <circle
        ...
        cy="65"
        r="4"
        className="fill-done/30 stroke-done"
        strokeWidth="1"
      />
    </svg>
  );
  ...
  return (
    <svg viewBox="0 0 120 90" className="size-28" fill="none">
      ...
      <rect
        ...
        height="10"
        rx="2"
        className="fill-line/30 stroke-line"
        strokeWidth="1"
      />
      <rect
        x="74"
      ...
      <rect
        ...
        height="10"
        rx="2"
        className="fill-missed/30 stroke-missed"
        strokeWidth="1"
      />
      <rect
        x="35"
      ...
      <rect
        ...
        height="10"
        rx="2"
        className="fill-done/60 stroke-done"
        strokeWidth="1"
      />
      <rect
        x="61"
      ...
      <rect
        ...
        height="10"
        rx="2"
        className="fill-done stroke-done"
        strokeWidth="1.5"
      />
      <rect
        x="87"
