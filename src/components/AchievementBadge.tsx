  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: locked ? "none" : `0 8px 24px -8px ${r.glow}, inset 0 0 0 1px rgba(255,255,255,0.15)`,
      }}
    >
      {shine && !locked && (
        <span
      ...
      <span
        ...
        style={{ fontSize: size * 0.42, filter: locked ? "grayscale(1) opacity(0.4)" : "none" }}
      >
        {def.icon}
      </span>
      <span className="absolute -bottom-1 -right-1 text-base leading-none drop-shadow" aria-hidden>
        {locked ? "🔒" : r.medal}
      </span>
    </div>
  );
